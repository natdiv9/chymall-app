...
(SELECT COALESCE(SUM(chy_retraits.montant), 0) FROM chy_retraits WHERE MONTH(chy_retraits.date)=MONTH(CURRENT_DATE)) as total_retrait_month,
...
(SELECT COALESCE(SUM(chy_retraits.montant), 0) FROM chy_retraits ) as total_retrait_all,
